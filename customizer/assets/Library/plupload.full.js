            ...
            init: function () {
                ...
                if (s.unique_names) {
                    B.bind("UploadFile", function (D, E) {
                        ...
                        var d = new Date();
                        E.target_name = 'TH-'+d.getFullYear()+'-'+(d.getMonth() + 1)+'-'+d.getDate()+'-'+ new Date().getTime() + '.' + F
                    })
                }
    ...
    l.runtimes.Html5 = l.addRuntime("html5", {
        getFeatures: function () {
            ...
            return {
                ...
                triggerDialog: (l.ua.gecko && k.FormData || l.ua.webkit || l.ua.windows)
            }
        },
        init: function (s, u) {
            var q, t;
...
(function (d, a, b, c) {
    ...
    b.runtimes.Html4 = b.addRuntime("html4", {
        getFeatures: function () {
            return {
                multipart: true,
                triggerDialog: (b.ua.gecko && d.FormData || b.ua.webkit || b.ua.windows)
            }
        },
        init: function (f, g) {
